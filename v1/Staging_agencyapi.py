...
def init_the_testing(campaign_id, business_id , keywordname_id, Campaign_Status):
    Piroty_token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..D9PIgLmErUUEzciAzbfoyjKjSgYoYYeZWTSq6-uVPLo"
    ...
    Campaign_ITd = "46272" #use able43187
    # (API must have for last key)
    Campaign_IFrf = "46271" #use able
    # (API must have Business Auth)
    Campaign_IHrt = "46270" #use able
    Client_id = "6152"
    ...
    api_list = [
        #  ====//// == Agency API == ////=======
            ...
            
            {
                ...
                "params":
                    {
                        "user_name": "-AI-TEST-user_name45422",
                        "email": email,
                        "password": password
                    },
            },
            ...
            
            {
                ...
                "params": 
                        {
                        "user_name": "test-agency-for-agency-API",
                        "password": "Usman@112"
                        }
            },
            ...
            # # ======================================
            {
                ...
                "url": f"https://maps-agency.locafy.com/graphs/campaign-map-rank-score/46270/",
                "method": "GET",
                "params":None
            },
            {
                "description": "Get Keyword Map Rank Score by providing Campaign id and keyword name",
                "url": f"https://maps-agency.locafy.com/graphs/keyword-map-rank-score/46270/software company",
                "method": "GET",
                "params":None
            },
            {
                "description": "Get Competitor Map Rank Score by providing Campaign id and keyword name",
                "url": f"https://maps-agency.locafy.com/graphs/competitor-map-rank-score/46270/software company",
                "method": "GET",
                "params":None
            }, 
            #======================================
            ...
            #     "url": "https://maps-agency.locafy.com/project/create/",
            #     "method": "POST",
            #     "params":
            #         {
            ...
            #     "url": "https://maps-agency.locafy.com/grid_tracking/campaigns/create/",
            #     "method": "POST",
            #     "params":
            #         {
            #         "user_id": User_id,
            ...
            #     "url": "https://maps-agency.locafy.com/grid_tracking/campaigns/campaign_id_placeholdcd/latest-gif-urls/",
            #     "method": "GET",
            #     "params":
            #         None
            ...
            #     "url": "https://maps-agency.locafy.com/grid_tracking/campaigns/645790542/latest-gif-urls/",
            #     "method": "GET",
            #     "params":
            #         None
            ...
            #     "url": "https://maps-agency.locafy.com/grid_tracking/campaigns/update/campaign_id_placeholdcd/",
            #     "method": "PUT",
            #     "params":
            #         {
            ...
            #     "url": "https://maps-agency.locafy.com/grid_tracking/campaigns/update/649852542/",
            #     "method": "PUT",
            #     "params":
            #         {
            #         "campaign_name": Grid_Campaign_name_Edit,
            ...
            #     "url": "https://maps-agency.locafy.com/grid_tracking/campaigns/delete/campaign_id_placeholdcd/",
            #     "method": "DELETE",
            #     "params":
            #         None
            ...
            #     "url": "https://maps-agency.locafy.com/grid_tracking/campaigns/delete/987654345678/",
            #     "method": "DELETE",
            #     "params":
            #         None
    ...
    result_file = "Staging_API_result.csv"
