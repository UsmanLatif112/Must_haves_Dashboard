...
def init_the_testing(campaign_id, business_id , keywordname_id, Campaign_Status):
    Piroty_token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..P9MveL09NHwTGGHjx8HkjbW3FdSBMQvVAZe1HQSPPSU"
    ...
    Campaign_ITd = "43187" #use able43187
    ...
    api_list = [
        #  ====//// == Agency API == ////=======
            ...
            
            {
                ...
                "url": "https://agency.brandsignals.io/grid_tracking/campaigns/campaign_id_placeholdcd/latest-gif-urls/",
                "method": "GET",
                "params":
                    None
            ...
            
            {
                ...
                "url": "https://agency.brandsignals.io/grid_tracking/campaigns/update/campaign_id_placeholdcd/",
                "method": "PUT",
                "params":
                    {
            ...
            
            {
                ...
                "url": "https://agency.brandsignals.io/grid_tracking/campaigns/delete/campaign_id_placeholdcd/",
                "method": "DELETE",
                "params":
                    None
