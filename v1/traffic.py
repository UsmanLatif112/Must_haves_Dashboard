...
class TrafficBase:
    def add_tagify_data(self, base_page, campaign, driver):
        ...
        if "wildcard_string" in campaign["fields"]:
            wildcard_field = base_page.wait_for_element(resources.TrafficModuleLocator.campaign_wildcard_strign)
            base_page.send_key_with_action_chain(wildcard_field, campaign_wildcard_string)
            
        if "tier1_url" in campaign["fields"]:
            wildcard_field = base_page.wait_for_element(resources.TrafficModuleLocator.campaign_tier1_url)
            base_page.send_key_with_action_chain(wildcard_field, campaign_tier1_url)
            
        if "tier2_url" in campaign["fields"]:
            wildcard_field = base_page.wait_for_element(resources.TrafficModuleLocator.campaign_tier2_url)
            base_page.send_key_with_action_chain(wildcard_field, campaign_tier2_url)

        if "destination_url" in campaign["fields"]:
            wildcard_field = base_page.wait_for_element(resources.TrafficModuleLocator.campaign_destination_url)
            base_page.send_key_with_action_chain(wildcard_field, campaign_destination_url)
            
        if "keyword_modifiers" in campaign["fields"]:
            wildcard_field = base_page.wait_for_element(resources.TrafficModuleLocator.campaign_keyword_modifiers)
    ...
    def add_input_field_data(self, base_page, campaign, driver):
        ...
        if "image_base64_code" in campaign["fields"]:
            base_page.wait_for_element(resources.TrafficModuleLocator.campaign_image_base64).send_keys(campaign_image_base64)
        ...
        if "gmb_cid" in campaign["fields"]:
            base_page.wait_for_element(resources.TrafficModuleLocator.campaign_gmb_cid).send_keys(campaign_gmb_cid)
        if "geo_latitude" in campaign["fields"]:
            base_page.wait_for_element(resources.TrafficModuleLocator.campaign_geo_latitude).send_keys(campaign_geo_latitude)
        if "geo_longitude" in campaign["fields"]:
            base_page.wait_for_element(resources.TrafficModuleLocator.campaign_geo_longitude).send_keys(campaign_geo_longitude)
    ...
    def edit_input_field_data(self, base_page, campaign, driver):
        ...
        if "image_base64_code" in campaign["fields"]:
            image_base64_field = base_page.wait_for_element(resources.TrafficModuleLocator.campaign_image_base64)
            image_base64_field.clear()
            image_base64_field.send_keys(campaign_image_base64_edited)
            
        if "image_url" in campaign["fields"]:
            image_url_field = base_page.wait_for_element(resources.TrafficModuleLocator.campaign_image_url)
        ...
        average_session_field = base_page.wait_for_element(resources.TrafficModuleLocator.campaign_average_session)
        ...
        base_page.wait_for_element(resources.TrafficModuleLocator.campaign_frequency_option)
        base_page.click_btn(resources.TrafficModuleLocator.campaign_frequency_option)
        
        input_field = base_page.wait_for_element(resources.TrafficModuleLocator.campaign_edit_name_input.format(campaign_name=self.campaign_name))
        input_field.clear()
        input_field.send_keys(campaign_name_edited)
        return campaign_name_edited
    ...
    def edit_campaign_check(self, base_page, campaign, driver):
        ...
        if "image_base64_code" in campaign["fields"]:
            image_base64_field = base_page.wait_for_element(resources.TrafficModuleLocator.campaign_image_base64_edit_check.format(campaign_image_base64=campaign_image_base64_edited))
            if not image_base64_field and passed:
                passed = False
                
        if "image_url" in campaign["fields"]:
            image_url_field = base_page.wait_for_element(resources.TrafficModuleLocator.campaign_image_url_edit_check.format(campaign_image_url="https://chatbotkings.com.au/wp-content/uploads/2023/03/LOGO-Chatbot-1-511x652.png"))
            if not image_url_field and passed:
                passed = False
                
        if "wildcard_string" in campaign["fields"]:
            wildcard_field = base_page.wait_for_element(resources.TrafficModuleLocator.campaign_wildcard_edit_check.format(campaign_wildcard=campaign_wildcard_string_edited[-1]))
            if not wildcard_field and passed:
                passed = False
                
        if "tier1_url" in campaign["fields"]:
            wildcard_field = base_page.wait_for_element(resources.TrafficModuleLocator.campaign_tier1_url_edit_check.format(campaign_tier1_url=campaign_tier1_url_edited[-1]))
            if not wildcard_field and passed:
                passed = False
                
        if "tier2_url" in campaign["fields"]:
            wildcard_field = base_page.wait_for_element(resources.TrafficModuleLocator.campaign_tier2_url_edit_check.format(campaign_tier2_url=campaign_tier2_url_edited[-1]))
            if not wildcard_field and passed:
                passed = False
                
        if "destination_url" in campaign["fields"]:
            wildcard_field = base_page.wait_for_element(resources.TrafficModuleLocator.campaign_destination_url_edit_check.format(campaign_destination_url=campaign_destination_url_edited[-1]))
            if not wildcard_field and passed:
                passed = False
                
        if "keyword_modifiers" in campaign["fields"]:
            wildcard_field = base_page.wait_for_element(resources.TrafficModuleLocator.campaign_keyword_modifiers_edit_check.format(campaign_keyword_modifiers=campaign_keyword_modifiers_edited[-1]))
            if not wildcard_field and passed:
                passed = False
                
        if "direct_url" in campaign["fields"]:
            wildcard_field = base_page.wait_for_element(resources.TrafficModuleLocator.campaign_direct_url_edit_check.format(campaign_direct_url=campaign_direct_url_edited[-1]))
            if not wildcard_field and passed:
                passed = False
                
        if "brand_name" in campaign["fields"]:
            brand_name_field = base_page.wait_for_element(resources.TrafficModuleLocator.campaign_brand_name_edit_check.format(campaign_brand_name=campaign_brand_name_edited))
            if not brand_name_field and passed:
                passed = False
                
        campaign_edited = base_page.wait_for_element(resources.TrafficModuleLocator.campaign_name_edit_check.format(campaign_name=campaign_name_edited))
        if not campaign_edited and passed:
            passed = False
            
        average_session_field = base_page.wait_for_element(resources.TrafficModuleLocator.campaign_average_session_edit_check.format(campaing_average_session=campaign_average_session_edited))
        if not average_session_field and passed:
            passed = False
            
        # frequency_field = base_page.wait_for_element(resources.TrafficModuleLocator.campaign_frequency_edit_check.format(frequency="Monthly"))
    ...
    def old_traffic_edit_fields(self, base_page, campaign, driver):
        if "keyword_modifiers" in campaign["fields"]:
            wildcard_field = base_page.wait_for_element(resources.OldTrafficModuleLocator.campaign_keyword_modifiers_edit_field.format(keyword=campaign_keyword_modifiers[-1]))
            base_page.remove_text(wildcard_field, campaign_keyword_modifiers[-1])
            base_page.send_key_with_action_chain(wildcard_field, campaign_keyword_modifiers_edited)

        if "direct_url" in campaign["fields"]:
            direct_url_field = base_page.wait_for_element(resources.OldTrafficModuleLocator.campaign_direct_url_edit_field.format(direct_url=campaign_direct_url[-1]))
        ...
        if "wildcard_string" in campaign["fields"]:
            wildcard_field = base_page.wait_for_element(resources.OldTrafficModuleLocator.campaign_wildcard_strign_edit_field.format(wildcard=campaign_wildcard_string[-1]))
            base_page.remove_text(wildcard_field, campaign_wildcard_string[-1])
            base_page.send_key_with_action_chain(wildcard_field, campaign_wildcard_string_edited)

        if "tier1_url" in campaign["fields"]:
            tier_1_url_field = base_page.wait_for_element(resources.OldTrafficModuleLocator.campaign_tier1_url_edit_field.format(tier_url=campaign_tier1_url[-1]))
        ...
        if "tier2_url" in campaign["fields"]:
            tier_2_url_field = base_page.wait_for_element(resources.OldTrafficModuleLocator.campaign_tier2_url_edit_field.format(tier_url=campaign_tier2_url[-1]))
        ...
        if "destination_url" in campaign["fields"]:
            wildcard_field = base_page.wait_for_element(resources.OldTrafficModuleLocator.campaign_destination_url_edit_field.format(destination_url=campaign_destination_url[-1]))
            base_page.remove_text(wildcard_field, campaign_destination_url[-1])
            base_page.send_key_with_action_chain(wildcard_field, campaign_destination_url_edited)
            
        if "brand_name" in campaign["fields"]:
            brand_name_field = base_page.wait_for_element(resources.OldTrafficModuleLocator.campaign_brand_name_edit_field.format(brand=campaign_brand_name))
            brand_name_field.clear()
            brand_name_field.send_keys(campaign_brand_name_edited)
            
        input_field = base_page.wait_for_element(resources.OldTrafficModuleLocator.campaign_edit_name_input.format(campaign_name=campaign_name))
        input_field.clear()
        input_field.send_keys(campaign_name_edited)
        
        average_session_field = base_page.wait_for_element(resources.OldTrafficModuleLocator.campaign_average_session_edit_field)
        average_session_field.clear()
        average_session_field.send_keys(campaign_average_session_edited)
        
            
        country_field = base_page.wait_for_element(resources.OldTrafficModuleLocator.campaign_country_edit_field)
    ...
    def old_traffic_edit_fields_check(self, base_page, campaign, driver):
        ...
        if "keyword_modifiers" in campaign["fields"]:
            keyword_modifiers_field = base_page.wait_for_element(resources.OldTrafficModuleLocator.campaign_keyword_modifiers_edit_field.format(keyword=campaign_keyword_modifiers_edited[-1]))
            if not keyword_modifiers_field and passed:
                passed = False

        if "direct_url" in campaign["fields"]:
            direct_url_field = base_page.wait_for_element(resources.OldTrafficModuleLocator.campaign_direct_url_edit_field.format(direct_url=campaign_direct_url_edited[-1]))
            if not direct_url_field and passed:
                passed = False

        if "wildcard_string" in campaign["fields"]:
            wildcard_field = base_page.wait_for_element(resources.OldTrafficModuleLocator.campaign_wildcard_strign_edit_field.format(wildcard=campaign_wildcard_string_edited[-1]))
            if not wildcard_field and passed:
                passed = False

        if "tier1_url" in campaign["fields"]:
            tier_1_url_field = base_page.wait_for_element(resources.OldTrafficModuleLocator.campaign_tier1_url_edit_field.format(tier_url=campaign_tier1_url_edited[-1]))
            if not tier_1_url_field and passed:
                passed = False
        
        if "tier2_url" in campaign["fields"]:
            tier_2_url_field = base_page.wait_for_element(resources.OldTrafficModuleLocator.campaign_tier2_url_edit_field.format(tier_url=campaign_tier2_url_edited[-1]))
            if not tier_2_url_field and passed:
                passed = False

        if "destination_url" in campaign["fields"]:
            destination_url_field = base_page.wait_for_element(resources.OldTrafficModuleLocator.campaign_destination_url_edit_field.format(destination_url=campaign_destination_url_edited[-1]))
            if not destination_url_field and passed:
                passed = False
        
        if "brand_name" in campaign["fields"]:
            brand_name_field = base_page.wait_for_element(resources.OldTrafficModuleLocator.campaign_brand_name_edit_field.format(brand=campaign_brand_name_edited))
            if not brand_name_field and passed:
                passed = False
        
        campaign_edited = base_page.wait_for_element(resources.OldTrafficModuleLocator.campaign_view_check.format(campaign_name=campaign_name_edited))
        if not campaign_edited and passed:
            passed = False
            
        average_session_field = base_page.wait_for_element(resources.OldTrafficModuleLocator.campaign_average_session_edit_field_check.format(average_session=campaign_average_session_edited))
        if not average_session_field and passed:
            passed = False
            
        # country_field = base_page.wait_for_element(resources.OldTrafficModuleLocator.campaign_country_edit_field_check.format(country=campaign_country_edited))
...
class CE_Traffic_TestCases(TrafficBase):
    ...
    def login_test_cases(self):
        ...
        try:
            ...
            self.driver.get(data.ce_traffic_url)
            self.base_page.wait_for_element(resources.TrafficModuleLocator.login_user).send_keys(data.ce_login_username)
            self.base_page.wait_for_element(resources.TrafficModuleLocator.login_password).send_keys("invalid_pass")
            self.base_page.click_btn(resources.TrafficModuleLocator.login_btn)
        ...
        try:
            ...
            self.driver.get(data.ce_traffic_url)
            self.base_page.wait_for_element(resources.TrafficModuleLocator.login_user).send_keys("invalid_user")
            self.base_page.wait_for_element(resources.TrafficModuleLocator.login_password).send_keys(data.ce_login_password)
            self.base_page.click_btn(resources.TrafficModuleLocator.login_btn)
...
class BS_Traffic_TestCases(TrafficBase):
    ...
    def project_id(self, value):
        # if value:  # only update if valid
        #     print(f"Setting project_id: {value}")
    ...
    @property
    def campaign_name_edited(self):
        return self._campaign_name_edited
    
    @campaign_name_edited.setter
    def campaign_name_edited(self, value):
        self._campaign_name_edited = value
    ...
    def crud_test_cases(self):
        try:
            ...
            # Test Case 1: Create Project
            self.base_page.click_btn(resources.TrafficModuleLocator.project_create_btn)
            self.base_page.wait_for_element(resources.TrafficModuleLocator.project_create_name_input).send_keys(self.project_name)  
            self.base_page.click_btn(resources.TrafficModuleLocator.project_create_modal_btn)
            project_created = self.base_page.wait_for_element(resources.TrafficModuleLocator.project_view_check)
            self.project_id = self.driver.current_url.split("/")[-2]
            self.driver.get(data.bs_project_listing_page)
            project_found_in_listing = self.base_page.wait_for_element(resources.TrafficModuleLocator.project_created_list_check.format(project_id=self.project_id))
        ...
        if self.project_id:
            try:
                # Test Case 2: Edit Project
                self.driver.get(data.bs_project_listing_page)
                self.base_page.click_btn(resources.TrafficModuleLocator.project_edit_btn.format(project_id=self.project_id))
                ...
                time.sleep(5)
                self.base_page.click_btn(resources.TrafficModuleLocator.project_edit_modal_btn.format(project_id=self.project_id))
            ...
            try:
                # Test Case 3: View Project
                self.driver.get(data.bs_project_listing_page)
                self.base_page.click_btn(resources.TrafficModuleLocator.project_created_list_check.format(project_id=self.project_id))
            ...
            try:
                ...
                def fill_campaign_form(campaign):
                    ...
                    self.base_page.click_btn(resources.TrafficModuleLocator.campaign_sub_category)
                    self.base_page.click_btn(resources.TrafficModuleLocator.campaign_sub_category_option.format(campaign_sub_type=campaign["campaign_sub_type"]))
                    # Step 1: Get dropdown element

                    from selenium.webdriver.common.action_chains import ActionChains
                    from selenium.webdriver.common.keys import Keys

                    try:
                        print("Trying normal dropdown selection...")

                        # Step 1: Click dropdown
                        self.base_page.click_btn(resources.TrafficModuleLocator.campaign_country)

                        # Step 2: Type country
                        country_input = self.base_page.wait_for_element(
                            resources.TrafficModuleLocator.campaign_country_input
                        )
                        country_input.clear()
                        country_input.send_keys(campaign_country)

                        # Step 3: Wait & select option (uppercase match)
                        option_country = self.base_page.wait_for_element(
                            f'//span[contains(@class,"select2-dropdown")]//li[contains(text(), "{campaign_country.upper()}")]'
                        )

                        option_country.click()

                        print(f"Option found for country: {option_country is not None}")

                        if option_country:
                            self.driver.execute_script("arguments[0].click();", option_country)
                            print("✅ Country selected via normal flow")
                        else:
                            raise Exception("Option not found")

                    except Exception as e:
                        print(f"⚠️ Normal flow failed: {e}")
                        print("🔁 Falling back to ActionChains...")

                        try:
                            # Step 1: Click dropdown using ActionChains
                            country_dropdown = self.base_page.wait_for_element(
                                resources.TrafficModuleLocator.campaign_country
                            )
                            ...
                            ActionChains(self.driver)\
                                .move_to_element(country_input)\
                                .click()\
                                .send_keys(campaign_country)\
                                .perform()

                            # Step 4: Select using keyboard (🔥 most reliable)
                            country_input.send_keys(Keys.ARROW_DOWN)
                            country_input.send_keys(Keys.ENTER)

                            print("✅ Country selected via ActionChains fallback")
            ...
            try:
                # Test Case 2: View Campaign
                time.sleep(2)
                self.base_page.click_btn(resources.TrafficModuleLocator.campaign_create_check.format(campaign_name=self.campaign_name))
                campaign_viewed = self.base_page.wait_for_element(resources.TrafficModuleLocator.capmaign_view_check.format(campaign_name=self.campaign_name)), "Campaign view failed"
                self.campaign_id = self.driver.current_url.split("/")[-2]
            ...
            try:
                # Test Case 3: Edit Campaign
                time.sleep(2)
                campaign_listing_url = data.bs_campaing_listing_page.format(project_id=self.project_id)
                print(campaign_listing_url)
                
                for attempt in range(3):
                    try:
                        self.driver.get(campaign_listing_url)
                        time.sleep(2)
                        self.driver.refresh()
                ...
                self.base_page.click_btn(resources.TrafficModuleLocator.campaing_edit_btn.format(campaign_id=self.campaign_id))
                
                self.edit_tagify_data(self.base_page, selected_campaign, self.driver)
                new_campaign_name = self.edit_input_field_data(self.base_page, selected_campaign, self.driver)
                self.campaign_name_edited = new_campaign_name

                print(f"Edited campaign name set to: {self.campaign_name_edited}")
                ...
                self.driver.execute_script("arguments[0].click();", cancel_btn)  
                time.sleep(2)
                self.base_page.click_btn(resources.TrafficModuleLocator.campaign_create_check.format(campaign_name=self.campaign_name_edited))
                campaign_edited = self.edit_campaign_check(self.base_page, selected_campaign, self.driver), "Campaign edit failed"
            ...
            try:
                # Test Case 4: View Campaign After Edit
                self.driver.get(data.bs_campaing_listing_page.format(project_id=self.project_id))
                time.sleep(2)
                self.base_page.click_btn(resources.TrafficModuleLocator.campaign_create_check.format(campaign_name=self.campaign_name_edited))
                campaign_viewed = self.base_page.wait_for_element(resources.TrafficModuleLocator.capmaign_view_check.format(campaign_name=self.campaign_name_edited)), "Campaign view failed"
                self.campaign_id = self.driver.current_url.split("/")[-2]
            ...
            try:
                ...
                self.driver.get(data.bs_campaing_listing_page.format(project_id=self.project_id))
                time.sleep(2)
                self.base_page.click_btn(resources.TrafficModuleLocator.campaign_live_btn.format(campaign_id=self.campaign_id))
                campaign_live = self.base_page.wait_for_element(resources.TrafficModuleLocator.live_status), "Campaign live failed"
            ...
            try:
                ...
                time.sleep(2)
                self.base_page.click_btn(resources.TrafficModuleLocator.campaign_live_btn.format(campaign_id=self.campaign_id))
                campaign_live = self.base_page.wait_for_element(resources.TrafficModuleLocator.cancel_status), "Campaign live Done"
            ...
            try:
                # Test Case 4: Delete Campaign
                time.sleep(2)
                delete_btn = self.base_page.wait_for_element(resources.TrafficModuleLocator.campaing_delete_btn.format(campaign_id=self.campaign_id))
                self.driver.execute_script("arguments[0].click();", delete_btn)
                time.sleep(2)
                delete_modal_btn = self.base_page.wait_for_element(resources.TrafficModuleLocator.capmaign_delete_modal_btn)
                self.driver.execute_script("arguments[0].click();", delete_modal_btn)
                campaign_deleted = not self.base_page.wait(resources.TrafficModuleLocator.campaign_create_check.format(campaign_name=self.campaign_name)), "Campaign deletion success"
            ...
            try:
                ...
                self.driver.get(data.bs_project_listing_page)
                time.sleep(2)
                delete_btn = self.base_page.wait_for_element(resources.TrafficModuleLocator.project_delete_btn.format(project_id=self.project_id))
                self.driver.execute_script("arguments[0].click();", delete_btn)
                time.sleep(2)
                delete_modal_btn = self.base_page.wait_for_element(resources.TrafficModuleLocator.project_delete_modal_btn)
                self.driver.execute_script("arguments[0].click();", delete_modal_btn)
                ...
                is_present = self.base_page.is_element_present(
                    resources.TrafficModuleLocator.project_deleted_list_check.format(project_id=self.project_id)
                )
...
class Tiger_Traffic_TestCases(TrafficBase):    
    ...
    def login_test_cases(self):
        ...
        try:
            # Test Case 2: Valid Username, Invalid Password
            self.driver.get(data.tiger_traffic_url)
            self.base_page.wait_for_element(resources.TrafficModuleLocator.login_user).send_keys(data.tiger_login_username)
            self.base_page.wait_for_element(resources.TrafficModuleLocator.login_password).send_keys("invalid_pass")
            self.base_page.click_btn(resources.TrafficModuleLocator.login_btn)
            login_result = self.base_page.wait(resources.TrafficModuleLocator.main_content), "Login succeeded with invalid password"
        ...
        try:
            ...
            self.driver.get(data.tiger_traffic_url)
            self.base_page.wait_for_element(resources.TrafficModuleLocator.login_user).send_keys("invalid_user")
            self.base_page.wait_for_element(resources.TrafficModuleLocator.login_password).send_keys(data.tiger_login_password)
            self.base_page.click_btn(resources.TrafficModuleLocator.login_btn)
            login_result = self.base_page.wait(resources.TrafficModuleLocator.main_content), "Login succeeded with invalid username"
...
class Torrential_Traffic_TestCases(TrafficBase):
    ...
    def login_test_cases(self):
        try:
            ...
            self.base_page.wait_for_element(resources.OldTrafficModuleLocator.login_user).send_keys("invalid_user")
            self.base_page.wait_for_element(resources.OldTrafficModuleLocator.login_password).send_keys("invalid_pass")
        ...
        try:
            # Test Case 2: Valid Username, Invalid Password
            self.driver.get(data.torrential_traffic_url)
            self.base_page.wait_for_element(resources.OldTrafficModuleLocator.login_user).send_keys(data.torrential_login_username)
            self.base_page.wait_for_element(resources.OldTrafficModuleLocator.login_password).send_keys("invalid_pass")
            self.base_page.click_btn(resources.OldTrafficModuleLocator.login_btn)
        ...
        try:
            ...
            self.driver.get(data.torrential_traffic_url)
            self.base_page.wait_for_element(resources.OldTrafficModuleLocator.login_user).send_keys("invalid_user")
            self.base_page.wait_for_element(resources.OldTrafficModuleLocator.login_password).send_keys(data.torrential_login_password)
            self.base_page.click_btn(resources.OldTrafficModuleLocator.login_btn)
        ...
        try:
            ...
            self.base_page.wait_for_element(resources.OldTrafficModuleLocator.login_password).send_keys(data.torrential_login_password)
            self.base_page.click_btn(resources.OldTrafficModuleLocator.login_btn)
            login_result = self.base_page.wait_for_element(resources.OldTrafficModuleLocator.main_content), "Login failed with valid credentials"
    ...
    def crud_test_cases(self):
        try:
            ...
            time.sleep(3)
            self.base_page.wait_for_element(resources.OldTrafficModuleLocator.project_create_name_input).send_keys(project_name)
            self.base_page.click_btn(resources.OldTrafficModuleLocator.project_create_modal_btn)
            project_created = self.base_page.wait_for_element(resources.OldTrafficModuleLocator.project_created_list_check.format(project_name=project_name)), "Project creation failed"
        ...
        try:
            ...
            project_viewed = self.base_page.wait_for_element(resources.OldTrafficModuleLocator.project_view_check.format(project_name=project_name)), "Project view failed"
            project_id = self.driver.current_url.split("/")[-2]
        ...
        try:
            ...
            time.sleep(2)
            project_edit_input = self.base_page.wait_for_element(resources.OldTrafficModuleLocator.project_edit_name_input)
            time.sleep(2)
            project_edit_input.clear()
            time.sleep(2)
            project_edit_input.send_keys(edited_project_name)
            ...
            time.sleep(6)
            project_edited = self.base_page.wait_for_element(resources.OldTrafficModuleLocator.project_edit_check.format(edited_project_name=edited_project_name)), "Project edit failed"
        ...
        try:
            ...
            project_viewed = self.base_page.wait_for_element(resources.OldTrafficModuleLocator.project_view_check.format(project_name=edited_project_name)), "Project view failed"
            project_id = self.driver.current_url.split("/")[-2]
        ...
        try:
            ...
            def fill_campaign_form(campaign):
                ...
                time.sleep(2)
                country_field = self.base_page.wait_for_element(resources.OldTrafficModuleLocator.campaign_country)
                ...
                time.sleep(2)
                self.base_page.wait_for_element(resources.OldTrafficModuleLocator.campaign_average_session).send_keys(campaign_average_session)
                time.sleep(2)
                if "keyword_modifiers" in campaign["fields"]:
                    wildcard_field = self.base_page.wait_for_element(resources.OldTrafficModuleLocator.campaign_keyword_modifiers)
                    self.base_page.send_key_with_action_chain(wildcard_field, campaign_keyword_modifiers)

                if "direct_url" in campaign["fields"]:
                    direct_url_field = self.base_page.wait_for_element(resources.OldTrafficModuleLocator.campaign_direct_url)
                    self.base_page.send_key_with_action_chain(direct_url_field, campaign_direct_url)
                    
                if "wildcard_string" in campaign["fields"]:
                    wildcard_field = self.base_page.wait_for_element(resources.OldTrafficModuleLocator.campaign_wildcard_strign)
                    self.base_page.send_key_with_action_chain(wildcard_field, campaign_wildcard_string)

                if "tier1_url" in campaign["fields"]:
                    tier_1_url_field = self.base_page.wait_for_element(resources.OldTrafficModuleLocator.campaign_tier1_url)
                    self.base_page.send_key_with_action_chain(tier_1_url_field, campaign_tier1_url)

                    
                if "tier2_url" in campaign["fields"]:
                    tier_2_url_field = self.base_page.wait_for_element(resources.OldTrafficModuleLocator.campaign_tier2_url)
                    self.base_page.send_key_with_action_chain(tier_2_url_field, campaign_tier2_url)

                if "destination_url" in campaign["fields"]:
                    wildcard_field = self.base_page.wait_for_element(resources.OldTrafficModuleLocator.campaign_destination_url)
            ...
            try:
                ...
                fill_campaign_form(selected_campaign)
                time.sleep(5)
                submit_btn = self.base_page.wait_for_element(resources.OldTrafficModuleLocator.campaign_create_submit_btn)
            ...
            try:
                # Test Case 2: View Campaign
                time.sleep(10)
                campaign_create_check_btn = self.base_page.wait_for_element(resources.OldTrafficModuleLocator.campaign_create_check.format(campaign_name=campaign_name))
                self.driver.execute_script("arguments[0].click();", campaign_create_check_btn)
                campaign_viewed = self.base_page.wait_for_element(resources.OldTrafficModuleLocator.campaign_view_check.format(campaign_name=campaign_name)), "Campaign view failed"
                campaign_id = self.driver.current_url.split("/")[-2]
            ...
            try:
                ...
                time.sleep(2)
                edit_btn = self.base_page.wait_for_element(resources.OldTrafficModuleLocator.campaing_edit_btn.format(campaign_id=campaign_id))
                self.driver.execute_script("arguments[0].click();", edit_btn)
                time.sleep(2)
                self.old_traffic_edit_fields(self.base_page, selected_campaign, self.driver)

                save_btn = self.base_page.wait_for_element(resources.OldTrafficModuleLocator.campaign_edit_save_btn)
                self.driver.execute_script("arguments[0].click();", save_btn)
                time.sleep(6)
            ...
            try:
                ...
                self.driver.get(data.torrential_campaing_listing_page.format(project_id=project_id))
                time.sleep(10)
                campaign_create_check_btn = self.base_page.wait_for_element(resources.OldTrafficModuleLocator.campaign_create_check.format(campaign_name=campaign_name_edited))
                self.driver.execute_script("arguments[0].click();", campaign_create_check_btn)
                campaign_viewed = self.base_page.wait_for_element(resources.OldTrafficModuleLocator.campaign_view_check.format(campaign_name=campaign_name_edited)), "Campaign view failed"
                campaign_id = self.driver.current_url.split("/")[-2]
                print(f"Campaign ID: {campaign_id}")
            ...
            try:
                ...
                self.driver.get(data.torrential_campaing_listing_page.format(project_id=project_id))
                time.sleep(2)
                live_btn = self.base_page.wait_for_element(resources.OldTrafficModuleLocator.campaign_live_btn.format(campaign_id=campaign_id))
                self.driver.execute_script("arguments[0].click();", live_btn)
                time.sleep(3)
                live_modal_confirmation_btn = self.base_page.wait_for_element(resources.OldTrafficModuleLocator.campaing_live_modal_confirmation)
                self.driver.execute_script("arguments[0].click();", live_modal_confirmation_btn)
                time.sleep(10)
                self.driver.get(data.torrential_campaing_listing_page.format(project_id=project_id))
                time.sleep(10)
                campaign_live = self.base_page.wait_for_element(resources.OldTrafficModuleLocator.live_status), "Campaign live failed"
            ...
            try:
                # Test Case 5: Cancel Live Campaign
                time.sleep(2)
                stop_btn = self.base_page.wait_for_element(resources.OldTrafficModuleLocator.campaign_stop_btn.format(campaign_id=campaign_id))
                self.driver.execute_script("arguments[0].click();", stop_btn)
                time.sleep(3)
                stop_modal_confirmation_btn = self.base_page.wait_for_element(resources.OldTrafficModuleLocator.campaing_stop_modal_confirmation)
                self.driver.execute_script("arguments[0].click();", stop_modal_confirmation_btn)
                time.sleep(10)
                self.driver.get(data.torrential_campaing_listing_page.format(project_id=project_id))
                time.sleep(10)
                campaign_live = self.base_page.wait_for_element(resources.OldTrafficModuleLocator.stop_status), "Campaign live failed"
            ...
            try:
                # Test Case 4: Delete Campaign
                time.sleep(2)
                delete_btn = self.base_page.wait_for_element(resources.OldTrafficModuleLocator.campaing_delete_btn.format(campaign_id=campaign_id))
                self.driver.execute_script("arguments[0].click();", delete_btn)
                time.sleep(2)
                delete_modal_btn = self.base_page.wait_for_element(resources.OldTrafficModuleLocator.capmaign_delete_modal_btn)
                time.sleep(2)
                self.driver.execute_script("arguments[0].click();", delete_modal_btn)
                time.sleep(6)
            ...
            try:
                ...
                self.driver.get(data.torrential_project_listing_page)
                time.sleep(2)
                delete_btn = self.base_page.wait_for_element(resources.OldTrafficModuleLocator.project_delete_btn.format(project_id=project_id))
                self.driver.execute_script("arguments[0].click();", delete_btn)
                time.sleep(2)
                delete_modal_btn = self.base_page.wait_for_element(resources.OldTrafficModuleLocator.project_delete_modal_btn)
                self.driver.execute_script("arguments[0].click();", delete_modal_btn)
                time.sleep(6)
        ...
        try:
            ...
            for index, option in enumerate(project_filter_options):
                ...
                for campaign_index, option in enumerate(campaign_filter_options):
                    ...
                    table_rows = self.base_page.wait_for_element(resources.OldTrafficModuleLocator.report_result_row)
                    if table_rows:
...
class LDR_Traffic_TestCases(TrafficBase):    
    def __init__(self, campaign_type):
        self.driver = initialize_and_navigate(data.ldr_traffic_url)
        self.base_page = page.HomePage(self.driver)
        self.base_page.make_csv('LDR_traffic_must_haves.csv', f'Test Case,Use Case / Scenario,Result\n', new=True)
        self.campaign_type = campaign_type
        self.campaign_selected = None
    ...
    def login_test_cases(self):
        try:
            # Test Case 1: Invalid Login (Invalid Username and Password)
            self.driver.get(data.ldr_traffic_url)
            self.base_page.wait_for_element(resources.LDRModuleLocator.login_user).send_keys("invalid_user")
            self.base_page.wait_for_element(resources.LDRModuleLocator.login_password).send_keys("invalid_pass")
            self.base_page.click_btn(resources.LDRModuleLocator.login_btn)
            login_result = self.base_page.wait(resources.LDRModuleLocator.main_content), "Login succeeded with invalid credentials"
            self.base_page.make_csv("LDR_traffic_must_haves.csv", f'Login, Invalid Login (Invalid Username and Password), {"Pass" if not login_result[0] else f"Fail - {login_result[1]}"}\n', new=False)
        except Exception as e:
            self.base_page.make_csv("LDR_traffic_must_haves.csv", f'Login, Invalid Login (Invalid Username and Password),Fail\n', new=False)
        
        try:
            # Test Case 2: Valid Username, Invalid Password
            self.driver.get(data.ldr_traffic_url)
            self.base_page.wait_for_element(resources.LDRModuleLocator.login_user).send_keys(data.ldr_login_username)
            self.base_page.wait_for_element(resources.LDRModuleLocator.login_password).send_keys("invalid_pass")
            self.base_page.click_btn(resources.LDRModuleLocator.login_btn)
            login_result = self.base_page.wait(resources.LDRModuleLocator.main_content), "Login succeeded with invalid password"
            self.base_page.make_csv("LDR_traffic_must_haves.csv", f'Login, Invalid Login (valid Username and invalid Password), {"Pass" if not login_result[0] else f"Fail - {login_result[1]}"}\n', new=False)
        except Exception as e:
            self.base_page.make_csv("LDR_traffic_must_haves.csv", f'Login, Invalid Login (valid Username and invalid Password),Fail\n', new=False)
        
        try:
            # Test Case 3: Invalid Username, Valid Password
            self.driver.get(data.ldr_traffic_url)
            self.base_page.wait_for_element(resources.LDRModuleLocator.login_user).send_keys("invalid_user")
            self.base_page.wait_for_element(resources.LDRModuleLocator.login_password).send_keys(data.ldr_login_password)
            self.base_page.click_btn(resources.LDRModuleLocator.login_btn)
            login_result = self.base_page.wait(resources.LDRModuleLocator.main_content), "Login succeeded with invalid username"
            self.base_page.make_csv("LDR_traffic_must_haves.csv", f'Login, Invalid Login (invalid Username and valid Password), {"Pass" if not login_result[0] else f"Fail - {login_result[1]}"}\n', new=False)
        except Exception as e:
            self.base_page.make_csv("LDR_traffic_must_haves.csv", f'Login, Invalid Login (invalid Username and valid Password),Fail\n', new=False)
        ...
        try:
            ...
            self.base_page.wait_for_element(resources.LDRModuleLocator.login_password).send_keys(data.ldr_login_password)
            self.base_page.click_btn(resources.LDRModuleLocator.login_btn)
            login_result = self.base_page.wait(resources.LDRModuleLocator.main_content), "Login failed with valid credentials"
            self.base_page.make_csv("LDR_traffic_must_haves.csv", f'Login, Valid Login (valid Username and Password), {"Pass" if login_result[0] else f"Fail - {login_result[1]}"}\n', new=False)
        except Exception as e:
            self.base_page.make_csv("LDR_traffic_must_haves.csv", f'Login, Valid Login (valid Username and Password),Fail\n', new=False)

    def crud_test_cases(self):
        try:
            self.driver.get(data.ldr_project_listing_page)
        
            # Test Case 1: Create Project
            self.base_page.click_btn(resources.LDRModuleLocator.project_create_btn)
            time.sleep(2)
            self.base_page.wait_for_element(resources.LDRModuleLocator.project_create_name_input).send_keys(project_name)
            self.base_page.click_btn(resources.LDRModuleLocator.project_create_modal_btn)
            project_created = self.base_page.wait_for_element(resources.LDRModuleLocator.project_view_check), "Project creation failed"
            project_id = self.driver.current_url.split("/")[-2]
            self.driver.get(data.ldr_project_listing_page)
            project_found_in_listing = self.base_page.wait_for_element(resources.LDRModuleLocator.project_created_list_check.format(project_id=project_id)), "Project creation failed"
            self.base_page.make_csv("LDR_traffic_must_haves.csv", f'Project, Create Project, {"Pass" if project_created[0] and project_found_in_listing[0] else f"Fail - {project_created[1]}"}\n', new=False)
        except Exception as e:
            self.base_page.make_csv("LDR_traffic_must_haves.csv", f'Project, Create Project,Fail\n', new=False)  
        
        try:
            # Test Case 2: Edit Project
            time.sleep(2)
            self.driver.get(data.ldr_project_listing_page)
            self.base_page.click_btn(resources.LDRModuleLocator.project_edit_btn.format(project_id=project_id))
            project_edit_input = self.base_page.wait_for_element(resources.LDRModuleLocator.project_edit_name_input.format(project_name=project_name))
            project_edit_input.clear()
            project_edit_input.send_keys(edited_project_name)
            time.sleep(2)
            self.base_page.click_btn(resources.LDRModuleLocator.project_edit_modal_btn.format(project_id=project_id))
            project_edited = self.base_page.wait_for_element(resources.LDRModuleLocator.project_edit_check.format(edited_project_name=edited_project_name)), "Project edit failed"
            self.base_page.make_csv("LDR_traffic_must_haves.csv", f'Project, Edit Project, {"Pass" if project_edited[0] else f"Fail - {project_edited[1]}"}\n', new=False)
        except Exception as e:
            self.base_page.make_csv("LDR_traffic_must_haves.csv", f'Project, Edit Project,Fail\n', new=False)
        
        try:
            # Test Case 3: View Project
            time.sleep(2)
            self.driver.get(data.ldr_project_listing_page)
            self.base_page.click_btn(resources.LDRModuleLocator.project_created_list_check.format(project_id=project_id))
            project_viewed = self.base_page.wait_for_element(resources.LDRModuleLocator.project_view_check), "Project view failed"
            self.base_page.make_csv("LDR_traffic_must_haves.csv", f'Project, View Project, {"Pass" if project_viewed[0] else f"Fail - {project_viewed[1]}"}\n', new=False)
        except Exception as e:
            self.base_page.make_csv("LDR_traffic_must_haves.csv", f'Project, View Project,Fail\n', new=False)

        try:
            self.base_page.click_btn(resources.LDRModuleLocator.campaign_create_btn)
            ...
            def fill_campaign_form(campaign):
                self.base_page.wait_for_element(resources.LDRModuleLocator.campaign_name).send_keys(campaign_name)
                self.base_page.click_btn(resources.LDRModuleLocator.campaign_category)
                time.sleep(0.5)
                self.base_page.click_btn(resources.LDRModuleLocator.campaign_category_option.format(campaign_type=campaign["campaign_type"]))
                time.sleep(0.5)
                self.base_page.click_btn(resources.LDRModuleLocator.campaign_sub_category)
                time.sleep(0.5)
                self.base_page.click_btn(resources.LDRModuleLocator.campaign_sub_category_option.format(campaign_sub_type=campaign["campaign_sub_type"]))
                time.sleep(0.5)
                self.base_page.click_btn(resources.LDRModuleLocator.campaign_country)
                time.sleep(0.5)
                self.base_page.click_btn(resources.LDRModuleLocator.campaign_country_option.format(country=campaign_country))
            ...
            try:
                ...
                fill_campaign_form(selected_campaign)
                time.sleep(5)
                self.base_page.click_btn(resources.LDRModuleLocator.campaign_create_submit_btn)
                campaign_created = self.base_page.wait_for_element(resources.LDRModuleLocator.campaign_create_check.format(campaign_name=campaign_name)), "Campaign creation failed"
                self.base_page.make_csv("LDR_traffic_must_haves.csv", f'Campaign, Create Campaign, {"Pass" if campaign_created[0] else f"Fail - {campaign_created[1]}"}\n', new=False)
            except Exception as e:
                self.base_page.make_csv("LDR_traffic_must_haves.csv", f'Campaign, Create Campaign,Fail\n', new=False)
                
            try:
                # Test Case 2: View Campaign
                time.sleep(2)
                self.base_page.click_btn(resources.LDRModuleLocator.campaign_create_check.format(campaign_name=campaign_name))
                campaign_viewed = self.base_page.wait_for_element(resources.LDRModuleLocator.capmaign_view_check.format(campaign_name=campaign_name)), "Campaign view failed"
                campaign_id = self.driver.current_url.split("/")[-2]
                self.base_page.make_csv("LDR_traffic_must_haves.csv", f'Campaign, View Campaign, {"Pass" if campaign_viewed[0] else f"Fail - {campaign_viewed[1]}"}\n', new=False)
            except Exception as e:
                self.base_page.make_csv("LDR_traffic_must_haves.csv", f'Campaign, View Campaign,Fail\n', new=False)


            try:
                # Test Case 3: Edit Campaign
                time.sleep(2)
                self.driver.get(data.ldr_campaing_listing_page.format(project_id=project_id))
                self.base_page.click_btn(resources.LDRModuleLocator.campaing_edit_btn.format(campaign_id=campaign_id))
                
                self.edit_tagify_data(self.base_page, selected_campaign, self.driver)
                self.edit_input_field_data(self.base_page, selected_campaign, self.driver)

                save_btn = self.base_page.wait_for_element(resources.LDRModuleLocator.campaign_edit_save_btn)
                self.driver.execute_script("arguments[0].click();", save_btn)
                time.sleep(3)
                cancel_btn = self.base_page.wait_for_element(resources.LDRModuleLocator.campaign_cancel_btn)
                self.driver.execute_script("arguments[0].click();", cancel_btn)
                time.sleep(2)
                self.base_page.click_btn(resources.LDRModuleLocator.campaign_create_check.format(campaign_name=campaign_name_edited))
                campaign_edited = self.edit_campaign_check(self.base_page, selected_campaign, self.driver), "Campaign edit failed"
                self.base_page.make_csv("LDR_traffic_must_haves.csv", f'Campaign, Edit Campaign, {"Pass" if campaign_edited[0] else f"Fail - {campaign_edited[1]}"}\n', new=False)
            except Exception as e:
                self.base_page.make_csv("LDR_traffic_must_haves.csv", f'Campaign, Edit Campaign,Fail\n', new=False)
            ...
            try:
                ...
                time.sleep(2)
                self.base_page.click_btn(resources.LDRModuleLocator.campaign_create_check.format(campaign_name=campaign_name_edited))
                campaign_viewed = self.base_page.wait_for_element(resources.LDRModuleLocator.capmaign_view_check.format(campaign_name=campaign_name_edited)), "Campaign view failed"
                campaign_id = self.driver.current_url.split("/")[-2]
                time.sleep(5)
                self.base_page.make_csv("LDR_traffic_must_haves.csv", f'Campaign, View Campaign after edit, {"Pass" if campaign_viewed[0] else f"Fail - {campaign_viewed[1]}"}\n', new=False)
            except Exception as e:
                self.base_page.make_csv("LDR_traffic_must_haves.csv", f'Campaign, View Campaign after edit,Fail\n', new=False)
            ...
            try:
                ...
                self.driver.get(data.ldr_campaing_listing_page.format(project_id=project_id))
                time.sleep(2)
                self.base_page.click_btn(resources.LDRModuleLocator.campaign_live_btn.format(campaign_id=campaign_id))
                campaign_live = self.base_page.wait_for_element(resources.LDRModuleLocator.live_status), "Campaign live failed"
                self.base_page.make_csv("LDR_traffic_must_haves.csv", f'Campaign, Live Campaign, {"Pass" if campaign_live[0] else f"Fail - {campaign_live[1]}"}\n', new=False)
            except Exception as e:
                self.base_page.make_csv("LDR_traffic_must_haves.csv", f'Campaign, Live Campaign,Fail\n', new=False)

            try:
                # Test Case 5: Cancel Live Campaign
                time.sleep(2)
                self.base_page.click_btn(resources.LDRModuleLocator.campaign_live_btn.format(campaign_id=campaign_id))
                campaign_live = self.base_page.wait_for_element(resources.LDRModuleLocator.cancel_status), "Campaign live failed"
                self.base_page.make_csv("LDR_traffic_must_haves.csv", f'Campaign, Cancel Campaign, {"Pass" if campaign_live[0] else f"Fail - {campaign_live[1]}"}\n', new=False)
            except Exception as e:
                self.base_page.make_csv("LDR_traffic_must_haves.csv", f'Campaign, Cancel Campaign,Fail\n', new=False)
        
            try:
                # Test Case 4: Delete Campaign
                time.sleep(2)
                delete_btn = self.base_page.wait_for_element(resources.LDRModuleLocator.campaing_delete_btn.format(campaign_id=campaign_id))
                self.driver.execute_script("arguments[0].click();", delete_btn)
                time.sleep(2)
                delete_modal_btn = self.base_page.wait_for_element(resources.LDRModuleLocator.capmaign_delete_modal_btn)
                self.driver.execute_script("arguments[0].click();", delete_modal_btn)
                campaign_deleted = not self.base_page.wait(resources.LDRModuleLocator.campaign_create_check.format(campaign_name=campaign_name)), "Campaign deletion failed"
                self.base_page.make_csv("LDR_traffic_must_haves.csv", f'Campaign, Delete Campaign, {"Pass" if campaign_deleted else f"Fail - {campaign_deleted[1]}"}\n', new=False)

            except Exception as e:
                self.base_page.make_csv("LDR_traffic_must_haves.csv", f'Campaign, Delete Campaign,Fail\n', new=False)
        except Exception as e:
            self.base_page.make_csv("LDR_traffic_must_haves.csv", f'Campaign, CRUD Test Cases,Fail\n', new=False)
            
        try:
            # Test Case 4: Delete Project
            self.driver.get(data.ldr_project_listing_page)
            time.sleep(2)
            delete_btn = self.base_page.wait_for_element(resources.LDRModuleLocator.project_delete_btn.format(project_id=project_id))
            self.driver.execute_script("arguments[0].click();", delete_btn)
            time.sleep(2)
            delete_modal_btn = self.base_page.wait_for_element(resources.LDRModuleLocator.project_delete_modal_btn)
            self.driver.execute_script("arguments[0].click();", delete_modal_btn)
            project_deleted = not self.base_page.wait(resources.LDRModuleLocator.project_deleted_list_check.format(project_id=project_id)), "Project deletion failed"
            self.base_page.make_csv("LDR_traffic_must_haves.csv", f'Project, Delete Project, {"Pass" if project_deleted else f"Fail - {project_deleted[1]}"}\n', new=False)
        except Exception as e:
            self.base_page.make_csv("LDR_traffic_must_haves.csv", f'Project, Delete Project,Fail\n', new=False)
        return self.campaign_selected
    ...
    def report_test_cases(self):
        ...
        try:
            # Test Case 2: Select a project, a campaign, and filter records
            table_rows = None
            self.driver.get(data.ldr_report_page)
            time.sleep(2)
            self.base_page.click_btn(resources.LDRModuleLocator.report_project_filter)
            time.sleep(0.5)
            project_filter_options = self.base_page.wait_all(resources.LDRModuleLocator.report_project_filter_option)
            for index, option in enumerate(project_filter_options):
                if index == 0:
                    continue
                option.click()
                ...
                self.base_page.click_btn(resources.LDRModuleLocator.report_campaign_filter)
                time.sleep(0.5)
                campaign_filter_options = self.base_page.wait_all(resources.LDRModuleLocator.report_campaign_filter_option)
                for campaign_index, option in enumerate(campaign_filter_options):
                    if campaign_index == 0:
                        continue
                    option.click()
                    ...
                    table_rows = self.base_page.wait_for_element(resources.LDRModuleLocator.report_result_row)
                    if table_rows:
                        self.base_page.click_btn(resources.LDRModuleLocator.filter_all)
                        time.sleep(5)
                        self.base_page.click_btn(resources.LDRModuleLocator.filter_all_failed_option)
                        time.sleep(5)
                        self.base_page.click_btn(resources.LDRModuleLocator.filter_all)
                        time.sleep(5)
                        self.base_page.click_btn(resources.LDRModuleLocator.filter_all_success_option)
                        time.sleep(5)
                        table_rows = self.base_page.wait_for_element(resources.LDRModuleLocator.report_result_row)
                        if table_rows:
                            self.base_page.make_csv("LDR_traffic_must_haves.csv", f'Report, Filter by Project and Campaign, Pass\n', new=False)
                            break
                if table_rows:
                    break
                if index == 7:
                    self.base_page.make_csv("LDR_traffic_must_haves.csv", f'Report, Filter by Project and Campaign, Fail - No results found\n', new=False)
                    break
        except Exception as e:
            self.base_page.make_csv("LDR_traffic_must_haves.csv", f'Report, Filter by Project and Campaign, Fail\n', new=False)
            
    def campaign_error_and_graph_stats(self):
        try:
            self.driver.get(data.ldr_campaign_error_page)
            time.sleep(5)
            error_page_row = self.base_page.wait_for_element(resources.LDRModuleLocator.campaign_error_page_row).text
            data_list_24_days = error_page_row.split('\n')
            data_dict_24_days = {
                "campaing_id": data_list_24_days[0],
                "total_failed": data_list_24_days[1],
            ...
            self.base_page.click_btn(resources.LDRModuleLocator.campaing_error_filter)
            time.sleep(0.5)
            self.base_page.click_btn(resources.LDRModuleLocator.campaing_error_filter_7_day_option)
            
            self.base_page.click_btn(resources.LDRModuleLocator.campaing_error_filter)
            time.sleep(0.5)
            self.base_page.click_btn(resources.LDRModuleLocator.campaing_error_filter_30_day_option)
            
            self.base_page.click_btn(resources.LDRModuleLocator.campaing_error_filter)
            time.sleep(0.5)
            self.base_page.click_btn(resources.LDRModuleLocator.campaing_error_filter_today_option)
            ...
            if filter_check:
                self.base_page.make_csv("LDR_traffic_must_haves.csv", f'Campaign error and graph stats, Data Filtering, Pass\n', new=False)
            else:
                self.base_page.make_csv("LDR_traffic_must_haves.csv", f'Campaign error and graph stats, Data Filtering, Fail\n', new=False)
            
            time.sleep(5)
            self.base_page.click_btn(resources.LDRModuleLocator.campaign_link)
            detail_page_url = self.driver.current_url.replace('edit', 'detail')
            self.driver.get(detail_page_url)
            time.sleep(5)
            try:
            ...
            if google_recaptcha_check and wildcard_not_found_check and product_wildcard_not_found_check and total_failed_check:
                self.base_page.make_csv("LDR_traffic_must_haves.csv", f'Campaign error and graph stats, Error and Graph Stats, Pass\n', new=False)
            else:
                self.base_page.make_csv("LDR_traffic_must_haves.csv", f'Campaign error and graph stats, Error and Graph Stats, Fail\n', new=False)
        ...
        try:
            ...
            day_filter = self.base_page.wait_all(resources.LDRModuleLocator.campaing_error_filter)
            day_filter[2].click()
            time.sleep(0.5)
            day_7_filter = self.base_page.wait_all(resources.LDRModuleLocator.campaing_error_filter_7_day_option)
            day_7_filter[1].click()
            
            day_filter = self.base_page.wait_all(resources.LDRModuleLocator.campaing_error_filter)
            day_filter[2].click()
            time.sleep(0.5)
            day_30_filter = self.base_page.wait_all(resources.LDRModuleLocator.campaing_error_filter_30_day_option)
            day_30_filter[1].click()
            
            day_filter = self.base_page.wait_all(resources.LDRModuleLocator.campaing_error_filter)
            day_filter[2].click()
            time.sleep(0.5)
            day_today_filter = self.base_page.wait_all(resources.LDRModuleLocator.campaing_error_filter_today_option)
            day_today_filter[1].click()
            ...
            if filter_check:
                self.base_page.make_csv("LDR_traffic_must_haves.csv", f'Project error and graph stats, Data Filtering, Pass\n', new=False)
            else:
                self.base_page.make_csv("LDR_traffic_must_haves.csv", f'Project error and graph stats, Data Filtering, Fail\n', new=False)
            ...
            if google_recaptcha_check and wildcard_not_found_check and product_wildcard_not_found_check and total_failed_check:
                self.base_page.make_csv("LDR_traffic_must_haves.csv", f'Project error and graph stats, Error and Graph Stats, Pass\n', new=False)
            else:
                self.base_page.make_csv("LDR_traffic_must_haves.csv", f'Project error and graph stats, Error and Graph Stats, Fail\n', new=False)
    ...
    def full_dashboard_must_haves(self):
        ...
        self.report_test_cases()
        self.campaign_error_and_graph_stats()
        print("Full LDR Dashboard Must Haves Test Cases Completed")
        return self.campaign_selected
...
#             # Test Case 2: Valid Username, Invalid Password
#             self.driver.get(data.bs_traffic_url)
#             self.base_page.wait_for_element(resources.OldTrafficModuleLocator.login_user).send_keys(data.bs_login_username)
#             self.base_page.wait_for_element(resources.OldTrafficModuleLocator.login_password).send_keys("invalid_pass")
#             self.base_page.click_btn(resources.OldTrafficModuleLocator.login_btn)
#             login_result = self.base_page.wait(resources.OldTrafficModuleLocator.main_content), "Login succeeded with invalid password"
...
#             self.driver.get(data.bs_traffic_url)
#             self.base_page.wait_for_element(resources.OldTrafficModuleLocator.login_user).send_keys("invalid_user")
#             self.base_page.wait_for_element(resources.OldTrafficModuleLocator.login_password).send_keys(data.bs_login_password)
#             self.base_page.click_btn(resources.OldTrafficModuleLocator.login_btn)
#             login_result = self.base_page.wait(resources.OldTrafficModuleLocator.main_content), "Login succeeded with invalid username"
...
#                 self.base_page.click_btn(resources.OldTrafficModuleLocator.project_created_list_check.format(project_name=project_name))
#                 time.sleep(10)
#                 project_edited = self.base_page.wait_for_element(resources.OldTrafficModuleLocator.project_edit_check_2.format(edited_project_name=edited_project_name)), "Project edit failed"
...
#                 # Test Case 2: View Campaign
#                 time.sleep(10)
#                 campaign_create_check_btn = self.base_page.click_btn(resources.OldTrafficModuleLocator.campaign_create_check.format(campaign_name=campaign_name))
#                 # self.driver.execute_script("arguments[0].click();", campaign_create_check_btn)
#                 campaign_viewed = self.base_page.wait_for_element(resources.OldTrafficModuleLocator.campaign_view_check.format(campaign_name=campaign_name)), "Campaign view failed"
#                 campaign_id = self.driver.current_url.split("/")[-2]
#                 print(f"Campaign ID: {campaign_id}")
...
#                 self.driver.get(data.bs_campaing_listing_page.format(project_id=project_id))
#                 time.sleep(2)
#                 edit_btn = self.base_page.click_btn(resources.OldTrafficModuleLocator.campaing_edit_btn.format(campaign_id=campaign_id))
#                 # self.driver.execute_script("arguments[0].click();", edit_btn)
#                 time.sleep(2)
#                 self.old_traffic_edit_fields(self.base_page, selected_campaign, self.driver)

#                 save_btn = self.base_page.click_btn(resources.OldTrafficModuleLocator.campaign_edit_save_btn)
#                 # self.driver.execute_script("arguments[0].click();", save_btn)
#                 time.sleep(10)
#                 campaign_edited = self.old_traffic_edit_fields_check(self.base_page, selected_campaign, self.driver), "Campaign edit failed"
#                 self.base_page.make_csv("BS_traffic_must_haves.csv", f'Campaign, Edit Campaign, {"Pass" if campaign_edited[0] else f"Fail - {campaign_edited[1]}"}\n', new=False)
...
#                 self.driver.get(data.bs_campaing_listing_page.format(project_id=project_id))
#                 time.sleep(2)
#                 live_btn = self.base_page.click_btn(resources.OldTrafficModuleLocator.campaign_live_btn.format(campaign_id=campaign_id))
#                 time.sleep(3)
#                 live_modal_confirmation_btn = self.base_page.click_btn(resources.OldTrafficModuleLocator.campaing_live_modal_confirmation)
#                 time.sleep(5)
#                 self.driver.get(data.bs_campaing_listing_page.format(project_id=project_id))
#                 time.sleep(5)
#                 campaign_live = self.base_page.wait_for_element(resources.OldTrafficModuleLocator.live_status), "Campaign live failed"
...
#                 # Test Case 5: Cancel Live Campaign
#                 time.sleep(2)
#                 stop_btn = self.base_page.click_btn(resources.OldTrafficModuleLocator.campaign_stop_btn.format(campaign_id=campaign_id))
#                 time.sleep(3)
#                 stop_modal_confirmation_btn = self.base_page.click_btn(resources.OldTrafficModuleLocator.campaing_stop_modal_confirmation)
#                 time.sleep(5)
#                 self.driver.get(data.bs_campaing_listing_page.format(project_id=project_id))
#                 campaign_live = self.base_page.wait_for_element(resources.OldTrafficModuleLocator.stop_status), "Campaign live failed"
#                 self.base_page.make_csv("BS_traffic_must_haves.csv", f'Campaign, Cancel Campaign, {"Pass" if campaign_live[0] else f"Fail - {campaign_live[1]}"}\n', new=False)
...
#                 # Test Case 4: Delete Campaign
#                 time.sleep(2)
#                 delete_btn = self.base_page.click_btn(resources.OldTrafficModuleLocator.campaing_delete_btn.format(campaign_id=campaign_id))
#                 time.sleep(2)
#                 delete_modal_btn = self.base_page.click_btn(resources.OldTrafficModuleLocator.capmaign_delete_modal_btn)
#                 time.sleep(2)
#                 time.sleep(6)
#                 campaign_deleted = not self.base_page.wait(resources.OldTrafficModuleLocator.campaign_create_check.format(campaign_name=campaign_name)), "Campaign deletion failed"
#                 self.base_page.make_csv("BS_traffic_must_haves.csv", f'Campaign, Delete Campaign, {"Pass" if campaign_deleted else f"Fail - {campaign_deleted[1]}"}\n', new=False)
...
#                 self.driver.get(data.bs_project_listing_page)
#                 time.sleep(2)
#                 delete_btn = self.base_page.click_btn(resources.OldTrafficModuleLocator.project_delete_btn.format(project_id=project_id))
#                 time.sleep(2)
