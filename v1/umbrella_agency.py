...
campaign_id_placeholdedgrid = None
def init_the_testing(campaign_id, business_id , keywordname_id):
    Piroty_token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..PGwaGNUAt7bVgvvUZ7s7ZORCxbTR0ea5vbjU74HxuZQ"
    Campaign_IDd = str(campaign_id)
    business_CID_Id = str(business_id)
    keywordname_Id = str(keywordname_id).lower()
    Campaign_StatuSs = "Live"
    # ======================================
    auth_token = Piroty_token
    # ======================================
    Campaign_StatuS = f'{Campaign_StatuSs}'
    # (API must have for 8 key)
    Campaign_ITd = "43187" #use able41665
    # (API must have for last key)
    Campaign_IFrf = "43186" #use able
    # (API must have Business Auth)
    Campaign_IHrt = "41706" #use able
    Client_id = "4815"
    ...
    def hit_apis_and_save_results(api_list, auth_token, csv_filename):
        ...
        global campaign_id_placeholdedgrid
                ...
                try:
                   ...
                   # Extract campaign ID dynamically
                    ...
                    if description == "Create New Grid tracking Campaign" and response_code == 201:
                        ...
                        campaign_id_placeholdedgrid = created_campaignn_id

                        if created_campaignn_id:
                            print(f"Extracted campaign_id: {created_campaignn_id}")
                            for next_api in api_list:
                                if "campaign_id_placeholdedgrid" in next_api["url"]:
                                    next_api["url"] = next_api["url"].replace("campaign_id_placeholdedgrid", str(created_campaignn_id))
    ...
    api_list = [
        #  ====//// == Agency API == ////=======
            ...
            
            {
                ...
                "params": 
                        {
                        "user_name": "aitest-agency-api-admin",
                        "password": "lWaBC47yRkW4!ai4"
                        }
            },
            ...
            
            {
                ...
                "url": f"https://agency.brandsignals.io/campaigns/business/deauthorization/{Campaign_IHrt}",
                "method": "GET",
                "params": None
            },
            {
            ...
            },
            {
                ...
                "url": f"https://agency.brandsignals.io/campaigns/business/deauthorization/{Campaign_IFrf}",
                "method": "GET",
                "params": None
            }, 
            # # # # # =============================================================
            ...
            
            {
                ...
                "url": f"https://agency.brandsignals.io/campaigns/campaign_id_placeholder/",
                "method": "GET",
                "params": None
            },
            {
            ...
            
            {
                ...
                "url": f"https://agency.brandsignals.io/geo/gifs/urls/campaign/campaign_id_placeholder",
                "method": "GET",
                "params": None
            },
            {
            ...
            # # # ======================================
            {
                ...
                "url": f"https://agency.brandsignals.io/geo/grid/urls/campaign_id_placeholder/",
                "method": "GET",
                "params": None
            },
            ...
            
            {
                ...
                "url": f"https://agency.brandsignals.io/geo/grid/urls/latest/campaign_id_placeholder",
                "method": "GET",
                "params": None
            },
            ...
            
            {
                ...
                "url": f"https://agency.brandsignals.io/campaigns/live/campaign_id_placeholder/",
                "method": "PATCH",
                "params": None
            },
            ...
            
            {
                ...
                "url": f"https://agency.brandsignals.io/reporting/pdf/campaign_id_placeholder",
                "method": "GET",
                "params":None
            },
            ...
            # # ======================================
            {
                ...
                "url": f"https://agency.brandsignals.io/graphs/campaign-map-rank-score/41706/",
                "method": "GET",
                "params":None
            },
            {
                "description": "Get Keyword Map Rank Score by providing Campaign id and keyword name",
                "url": f"https://agency.brandsignals.io/graphs/keyword-map-rank-score/41706/software company",
                "method": "GET",
                "params":None
            },
            {
                "description": "Get Competitor Map Rank Score by providing Campaign id and keyword name",
                "url": f"https://agency.brandsignals.io/graphs/competitor-map-rank-score/41706/software company",
                "method": "GET",
                "params":None
            }, 
            #======================================
            ...
            
            {
                ...
                "url": f"https://agency.brandsignals.io/keyword/delete/'{Keyword_neww}'/campaign_id_placeholder",
                "method": "DELETE",
                "params": None
            },
            {
            ...
            },
            {
                ...
                "url": f"https://agency.brandsignals.io/keyword/delete/hello1/{Campaign_IFrf}",
                "method": "DELETE",
                "params": None
            },
            ...
            
            {
                ...
                "url": f"https://agency.brandsignals.io/campaigns/delete/campaign_id_placeholder/",
                "method": "DELETE",
                "params": None
            },
             ...
             # # ======================================
            {
                ...
                "url": f"https://agency.brandsignals.io/quick_analysis/campaigns/campaign_id_placeholded/",
                "method": "GET",
                "params":None
            },
            
            {
                ...
                "url": "https://agency.brandsignals.io/quick_analysis/campaigns/38685269/",
                "method": "GET",
                "params":None
            },
            # # ======================================
            {
                ...
                "url": f"https://agency.brandsignals.io/graphs/campaign-map-rank-score/campaign_id_placeholded/",
                "method": "GET",
                "params":None
            },
            {
                "description": "Get Keyword Map Rank Score by providing Quick analysis campaign id and keyword name",
                "url": f"https://agency.brandsignals.io/graphs/keyword-map-rank-score/campaign_id_placeholded/{keywords_for_analysis}",
                "method": "GET",
                "params":None
            },
            {
                "description": "Get Competitor Map Rank Score by providing Quick analysis campaign id and keyword name",
                "url": f"https://agency.brandsignals.io/graphs/competitor-map-rank-score/campaign_id_placeholded/{keywords_for_analysis}",
                "method": "GET",
                "params":None
            }, 
            # # ======================================
            
            {
                ...
                "url": f"https://agency.brandsignals.io/quick_analysis/campaigns/delete/campaign_id_placeholded/",
                "method": "DELETE",
                "params": None
            },
            ...
            {
                "description": "Create New Grid tracking project",
                "url": "https://agency.brandsignals.io/project/create/",
                "method": "POST",
                "params":
                    {
            ...
            {
                "description": "Create New Grid tracking Campaign",
                "url": "https://agency.brandsignals.io/grid_tracking/campaigns/create/",
                "method": "POST",
                "params":
                    {
                    "user_id": User_id,
                    "business_gmb_cid": business_gmb_CID,
                    "campaign_name": Grid_Campaign_name,
                    "keywords_for_analysis": keywords_for_analysis,
                    "grid_type": 7,
                    "grid_distance": 1,
                    "frequency": 1,
                    "execution_time": "07:50:37.054Z",
                    "project_id": campaign_id_placeholdertt,
                    "is_grid_tracking": 1
                    }
            }, 
                   
            {
                "description": "Create New Grid tracking Campaign with incorrect user id",
                "url": "https://agency.brandsignals.io/grid_tracking/campaigns/create/",
                "method": "POST",
                "params":
                    {
            ...
            {
                "description": "Create New Grid tracking Campaign with incorrect GMB CID",
                "url": "https://agency.brandsignals.io/grid_tracking/campaigns/create/",
                "method": "POST",
                "params":
                    {
                    "user_id": User_id,
                    "business_gmb_cid": "74512474521457414745145521452",
                    "campaign_name": Grid_Campaign_name,
                    "keywords_for_analysis": keywords_for_analysis,
                    "grid_type": 7,
                    "grid_distance": 1,
            ...
            {
                "description": "Get Grid tracking Campaign latest gif urls by providing correct campaign id",
                "url": "https://agency.brandsignals.io/grid_tracking/campaigns/campaign_id_placeholdedgrid/latest-gif-urls/",
                "method": "GET",
                "params":
                    None
            ...
            {
                "description": "Get Grid tracking Campaign latest gif urls by providing incorrect campaign id",
                "url": "https://agency.brandsignals.io/grid_tracking/campaigns/645790542/latest-gif-urls/",
                "method": "GET",
                "params":
                    None
            ...
            {
                "description": "Edit Grid tracking Campaign by providing correct campaign id",
                "url": "https://agency.brandsignals.io/grid_tracking/campaigns/update/campaign_id_placeholdedgrid/",
                "method": "PUT",
                "params":
                    {
                    "campaign_name": Grid_Campaign_name_Edit,
                    "grid_distance": 1,
                    "grid_type": 7,
                    "frequency": 1,
                    "execution_time": "07:50:37.054Z"
            ...
            {
                "description": "Edit Grid tracking Campaign by providing incorrect campaign id",
                "url": "https://agency.brandsignals.io/grid_tracking/campaigns/update/649852542/",
                "method": "PUT",
                "params":
                    {
                    "campaign_name": Grid_Campaign_name_Edit,
            ...
            {
                "description": "Delete Grid tracking Campaign by providing correct campaign id",
                "url": "https://agency.brandsignals.io/grid_tracking/campaigns/delete/campaign_id_placeholdedgrid/",
                "method": "DELETE",
                "params":
                    None
            ...
            {
                "description": "Delete Grid tracking Campaign by providing incorrect campaign id",
                "url": "https://agency.brandsignals.io/grid_tracking/campaigns/delete/987654345678/",
                "method": "DELETE",
                "params":
                    None
